...
## Solar panel pickup — works like battery (magnetic suction)
## but triggers the ending scene when collected.
...
func _collect() -> void:
	SceneTransition.change_scene_cut("res://scenes/ending.tscn", 2.0)
	queue_free()
